...
RcppExport SEXP _jsutils_hash_string_vector(SEXP svSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _jsutils_hash_string_vector_std(SEXP svSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const StringVector& >::type sv(svSEXP);
...
RcppExport SEXP _jsutils_hash_numeric_vector_std(SEXP svSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _jsutils_hash_integer_vector_std(SEXP svSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _jsutils_hash_logical_vector_std(SEXP svSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _jsutils_hash_combine(SEXP hash1SEXP, SEXP hash2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _jsutils_inplace(SEXP targetSEXP, SEXP srcSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_jsutils_hash_numeric_vector_std", (DL_FUNC) &_jsutils_hash_numeric_vector_std, 1},
    {"_jsutils_hash_integer_vector_std", (DL_FUNC) &_jsutils_hash_integer_vector_std, 1},
    {"_jsutils_hash_logical_vector_std", (DL_FUNC) &_jsutils_hash_logical_vector_std, 1},
    {"_jsutils_hash_combine", (DL_FUNC) &_jsutils_hash_combine, 2},
    {"_jsutils_inplace", (DL_FUNC) &_jsutils_inplace, 2},
    {NULL, NULL, 0}
};
